...
function removeDuplicateNested(arr) {
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    var found = false
    // Q: What are you going to do? 
    // A: Declare a variable 'found' with an initial value of false
    ...
    for (var j = 0; j < solutionArr.length; j++) {
      ...
      // Q: Why are you going to do it? 
      // A: to see if there are matching elements in the solutions array
      ...
      if (arr[i] === solutionArr[j]) {
        ...
        found = true;
        // Q: What are you going to do? 
        // A: Assign the variable `found` with a value of true
  ...
  // Q: Why are you going to do it? 
  // A: to return the solutions array with only unique values
}
...
// If 'i' value is not found in the object / associated array's keys. Then add the 'i' as a new key with the value as true, which wil be the first time an element is added.
// If 'i' value is found in the object / associated array's keys. Then 'i' will not insert it into the return array.
...
function removeDuplicate(arr) {
  ...
  // Q: How are you going to do it? 
  // A: assignment operator and hard brackets

  // Q: Why are you going to do it? 
  // A: to have a holding container for all non-duplicate values
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    var elm = arr[i];
    // Q: What are you going to do? 
    // A: assign the variable `elm` to the value of arr[i]
