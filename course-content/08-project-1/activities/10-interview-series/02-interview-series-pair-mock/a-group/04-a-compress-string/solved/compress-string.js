...
var compress = function (str) {
  ...
  // Q: What are you going to do? 
  // A: declare a variable 'currentLetter' with an initial value of the first character of the input string

  // Q: How are you going to do it? 
  // A: with an assignment operator and array bracket notation

  // Q: Why are you going to do it? 
  // A: to create a pointer to the first value of our input string

  var count = 1;
  // Q: What are you going to do? 
  // A: Declare a variable 'count' with an initial value of 1

  // Q: How are you going to do it? 
  // A: with an assignment operator

  // Q: Why are you going to do it? 
  // A: to create a counter for the number of each individual letter we will see
  ...
  if (!str.length) {
    ...
    // Q: What are you going to do? 
    // A: Run a conditional check (else if) to see if the Input String length is 1
  ...
  for (var i = 1; i < str.length; i++) {
    ...
    if (str[i] !== currentLetter && i !== str.length - 1) {
      // Q: What are you going to do? 
      // A: Check to see if the character at index `i` is not the current letter and not the final letter

      // Q: How are you going to do it? 
      // A: with a Conditional check that checks if BOTH conditions are not equal

      // Q: Why are you going to do it? 
      // A: to see if we have completed examining the initial element so that we can move on an concatenate both the character and the count before progressing onto the next character
      ...
      // Q: How are you going to do it? 
      // A: using an `else if` Conditional check 
      ...
      // Q: How are you going to do it? 
      // A: with a += operator and the assignment operator
