...
app.get("/", function(req,res){
  var html = "<p>Check out one of these paths:</p>"
  html += "<p><a href='/cast'>/cast</a></p>"
  html += "<p><a href='/coolness-chart'>/coolness-chart</a></p>"
  html += "<p><a href='/attitude-chart/opinionated'>/attitude-chart/opinionated</a></p>"
  html += "<p><a href='/attitude-chart/righteous'>/attitude-chart/righteous</a></p>"
  html += "<p><a href='/attitude-chart/awesome'>/attitude-chart/awesome</a></p>"
  html += "<p><a href='/attitude-chart/misunderstood'>/attitude-chart/misunderstood</a></p>"
