...
//   connection.query("SELECT * FROM quotes where author = ?", [req.params.author], function(err, data) {
//     if (err) {
//       return res.status(500).end();
//     }
...
//   connection.query("SELECT * FROM quotes where quote = ?", [req.params.quote], function(err, data) {
//     if (err) {
//       return res.status(500).end();
//     }
